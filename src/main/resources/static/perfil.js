...
async function cargarEstadisticasPerfil() {
    try {
        ...
        const pesoActualEl =
            document.getElementById('perfilPesoActual');

        const variacionEl =
            document.getElementById('perfilVariacion');

        const mediaEl =
            document.getElementById('perfilMedia');
        ...
        const ultimoRegistro =
            registrosOrdenados[registrosOrdenados.length - 1];
        ...
        // Media de los últimos 7 registros
        const ultimos7 =
            registrosOrdenados
                .slice(-7)
                .map(r => Number(r.pesoKg));
